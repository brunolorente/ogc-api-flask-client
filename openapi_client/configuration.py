...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "https://test.cubewerx.com/cubewerx/cubeserv/demo/ogcapi/Daraa"
            ...
            'cwApiKeyHeader':
                {
                    'type': 'api_key',
                    'in': 'header',
                    'key': 'CubeWerx-API-Key',
                    'value': self.get_api_key_with_prefix('CubeWerx-API-Key')
                },
            'cwApiKeyQuery':
                {
                    'type': 'api_key',
