...
class ConformanceClassesApi(object):
    ...
    def conformance_get(self, **kwargs):  # noqa: E501
        """The set of OGC API conformance classes that are supported for this data store.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.conformance_get(async_req=True)
        >>> result = thread.get()
        ...
        :return: ConformanceJson
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.conformance_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.conformance_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def conformance_get_with_http_info(self, **kwargs):  # noqa: E501
        """The set of OGC API conformance classes that are supported for this data store.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.conformance_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='ConformanceJson',  # noqa: E501
