...
class SourceImagesApi(object):
    ...
    def collections_collection_id_images_get(self, collection_id, **kwargs):  # noqa: E501
        """The set of source images of a collection.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.collections_collection_id_images_get(collection_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.collections_collection_id_images_get_with_http_info(collection_id, **kwargs)  # noqa: E501
        else:
            (data) = self.collections_collection_id_images_get_with_http_info(collection_id, **kwargs)  # noqa: E501
            return data

    def collections_collection_id_images_get_with_http_info(self, collection_id, **kwargs):  # noqa: E501
        """The set of source images of a collection.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.collections_collection_id_images_get_with_http_info(collection_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['collection_id', 'limit', 'offset', 'bbox', 'bbox_crs', 'datetime', 'f', 'pretty']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method collections_collection_id_images_get" % key
                )
        ...
        if ('collection_id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `collection_id` when calling `collections_collection_id_images_get`")  # noqa: E501

        if 'limit' in local_var_params and local_var_params['limit'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `collections_collection_id_images_get`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `collections_collection_id_images_get`, must be a value greater than or equal to `0`")  # noqa: E501
        if ('bbox' in local_var_params and
                len(local_var_params['bbox']) > 6):
            raise ApiValueError("Invalid value for parameter `bbox` when calling `collections_collection_id_images_get`, number of items must be less than or equal to `6`")  # noqa: E501
        if ('bbox' in local_var_params and
                len(local_var_params['bbox']) < 4):
            raise ApiValueError("Invalid value for parameter `bbox` when calling `collections_collection_id_images_get`, number of items must be greater than or equal to `4`")  # noqa: E501
        collection_formats = {}
    ...
    def collections_collection_id_images_image_id_get(self, collection_id, image_id, **kwargs):  # noqa: E501
        """Metadata about a source image of a collection, including links to the actual source image file(s).  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.collections_collection_id_images_image_id_get(collection_id, image_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str collection_id: The identifier of a collection in this data store. (required)
        :param str image_id: The identifier of a source image in this collection. (required)
        :param str f: A token indicating the content type to return.  Overrides the HTTP \"Accept\" header if present.
        :param bool pretty: Whether or not the output should be pretty-formatted (with whitespace, etc.).
        :return: str
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.collections_collection_id_images_image_id_get_with_http_info(collection_id, image_id, **kwargs)  # noqa: E501
        else:
            (data) = self.collections_collection_id_images_image_id_get_with_http_info(collection_id, image_id, **kwargs)  # noqa: E501
            return data

    def collections_collection_id_images_image_id_get_with_http_info(self, collection_id, image_id, **kwargs):  # noqa: E501
        """Metadata about a source image of a collection, including links to the actual source image file(s).  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.collections_collection_id_images_image_id_get_with_http_info(collection_id, image_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['collection_id', 'image_id', 'f', 'pretty']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method collections_collection_id_images_image_id_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'collection_id' is set
        if ('collection_id' not in local_var_params or
                local_var_params['collection_id'] is None):
            raise ApiValueError("Missing the required parameter `collection_id` when calling `collections_collection_id_images_image_id_get`")  # noqa: E501
        # verify the required parameter 'image_id' is set
        if ('image_id' not in local_var_params or
                local_var_params['image_id'] is None):
            raise ApiValueError("Missing the required parameter `image_id` when calling `collections_collection_id_images_image_id_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/collections/{collectionId}/images/{imageId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
